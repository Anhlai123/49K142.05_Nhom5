...
public class AddPriceFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setDayPillState(binding.dayT2, false);
        setDayPillState(binding.dayT3, false);
        setDayPillState(binding.dayT4, false);
        setDayPillState(binding.dayT5, false);
        setDayPillState(binding.dayT6, false);
        setDayPillState(binding.dayT7, false);
        setDayPillState(binding.dayCn, false);
